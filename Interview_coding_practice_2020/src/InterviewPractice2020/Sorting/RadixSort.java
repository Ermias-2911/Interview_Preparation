...
public class RadixSort {
    ...
    private static void countingSort(int[] arr, int position) {
        ...
        //Calculate each element frequency by modulo %10 each number
        // if we %10 each number we get reminder number after division.
        // This means we get the last digit number all the time.
        ...
        // Copy output array to the input array to
